...
public class OpenAiApiService {
    ...
    private static final String ANALYSIS_TEMPLATE = "你是一名聊天应用的群组管理员和垃圾信息检测器。你的任务是根据用户发言内容，判断其是否涉及垃圾广告、黄赌毒、引流、非法服务、虚拟货币交易、黑灰产、以及壮阳、性用品、迷药、夸张致富广告等内容。\n" +
            ...
            "14. **正常技术支持和站内服务豁免**：如果内容明显是在回答用户问题、解释节点、订阅、客户端、IP、域名被墙、线路故障、套餐入口等正常产品技术支持，或只是站内机器人提示“签到、每日流量、随机流量、绑定/未绑定本站账号、进入资料编辑”等服务状态，不要仅因出现代理、节点、IP、域名、被墙、订阅、账号、流量等词判定为广告。只有同时存在陌生引流、售卖、拉人、违规交易、成人/博彩/黑灰产推广时才提高风险分。\n" +
            "以下是用户的发言内容：\n%s\n" +
